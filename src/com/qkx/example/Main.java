...
import com.qkx.example.lc.hard.No25;
import com.qkx.example.lc.medium.No12x_13x.No134;
import com.qkx.example.lc.medium.x.No200;
...
//        System.out.println(new No10().isMatch("asdfasdfas", "asdf.*asdf.*s"));
        ...
        ListNode list = ListUtil.genList(1, 2, 3, 4, 5);
        ListUtil.print(list);
